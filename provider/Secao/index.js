...
export const SecaoProvider = ({ children }) => {
  ...
  const findSecao = (value, type) => {
    ...
    if(value === ""){
      ...
      if (value >= 1 & value < 9){
        return setSecao("A seção é: 0.5mm²")
      }
      else if (value >= 1 & value < 11){
        return setSecao("A seção é: 0.75mm²")
      }
      else if (value >= 1 & value < 14){
        return setSecao("A seção é: 1mm²")
      }
      else if (value >= 1 & value < 17.5){
        return setSecao("A seção é: 1.5mm²")
      }
      else if (value >= 1 & value < 24){
        return setSecao("A seção é: 2.5mm²")
      }
      else if (value >= 1 & value < 32){
        return setSecao("A seção é: 4mm²")
      }
      else if (value >= 1 & value <= 41){
        return setSecao("A seção é: 6mm²")
      }
      else if (value < 1 || value > 41){
      ...
      if (value >= 1 & value < 1143){
        ...
        return setSecao("A seção é: 1.0mm²")
      }
